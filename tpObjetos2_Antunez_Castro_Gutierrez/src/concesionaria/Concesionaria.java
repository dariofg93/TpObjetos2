...
public class Concesionaria {
	 ...
	 * Prec: Si no cumple algunas reglas tirar� regla alguna de estas excepciones:
	...
	/**
	 * Prop: Retorna el costo que impone la compa�ia aseguradora dados un
